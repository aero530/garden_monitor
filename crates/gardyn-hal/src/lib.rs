//! Hardware abstraction for the Gardyn edge agent.
//!
...
//! rule engine, and vision pipeline be developed against `gardyn-sim` on a desktop,
...
/// A captured frame. Pixel format is deliberately opaque here; `gardyn-vision` owns
/// decoding.
