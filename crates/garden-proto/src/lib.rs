...
pub struct TelemetryAccepted {
    ...
    pub schedule: Option<garden_hal::Schedule>,
}
...
pub mod topics {
    pub const TELEMETRY: &str = "garden/{garden}/telemetry";
    pub const FRAME: &str = "garden/{garden}/frame";
    pub const HEARTBEAT: &str = "garden/{garden}/heartbeat";
    pub const LIGHT_COMMAND: &str = "garden/{garden}/light/command";
    pub const PUMP_COMMAND: &str = "garden/{garden}/pump/command";
    ...
    pub const SCHEDULE: &str = "garden/{garden}/schedule";
