...
//!
//! Three stages, independently switchable, exactly as [`garden_core::Capability`]
//! models them:
//!
...
//! use garden_vision::{Analyzer, roi::RoiMap};
//!
...
use garden_core::{AlgaeReading, SlotId, SlotMetrics, Timestamp};
use image::RgbImage;
...
mod tests {
    use super::*;
    use garden_core::{Geometry, LensCalibration};
    use image::Rgb;
    ...
    fn growth_rate_needs_history_and_is_zero_until_it_has_some() {
        ...
        history.insert(
            ...
            vec![
                growth::Sample {
                    at: garden_core::time::add_days(t0(), -6.0),
                    area_cm2: 40.0,
                },
                growth::Sample {
                    at: garden_core::time::add_days(t0(), -4.0),
                    area_cm2: 60.0,
                },
                growth::Sample {
                    at: garden_core::time::add_days(t0(), -2.0),
                    area_cm2: 80.0,
                },
            ],
        );
