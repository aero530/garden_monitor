...
//!
//! Usage: `cargo run -p garden-sim [days]`

use garden_core::{Capability, GardenState, SlotId, Timestamp};
use garden_rules::{Engine, SuppressionReason, default_rules};
use garden_sim::Simulation;
use garden_sim::scenario::{Operator, Report, run};
